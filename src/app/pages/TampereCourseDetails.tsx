...
export function TampereCourseDetails() {
      ...
      <main className="ml-[280px] flex-1">
        ...
        <div className="px-12 pt-12 pb-6 bg-[#fafaf9]">
          ...
          <div className="text-sm text-gray-500 mb-4">
            ...
            {" / "}
            <span className="text-gray-700">COMP.CS.400</span>
          </div>

          {/* Title */}
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            COMP.CS.400 Software Project: Full-Stack Development
          </h1>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700">Coordinator: Dr. Antti Virtanen</span>
            </div>
        ...
        <div className="px-12 py-6 bg-[#fafaf9]">
          <div 
            className="w-full h-[300px] rounded-[20px] bg-gradient-to-br from-[#fa709a] to-[#fee140] flex items-center justify-center overflow-hidden relative"
          >
            {/* Abstract pattern for full-stack development */}
            <div className="absolute inset-0">
              <div className="absolute top-1/4 left-1/4 w-40 h-40 rounded-lg bg-white/10 rotate-45" />
              <div className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-white/15 rounded-full" />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <Smartphone className="w-24 h-24 text-white/20" strokeWidth={1} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                This intensive full-stack development course teaches students to build complete web applications from database to user interface. Students gain practical experience with modern JavaScript frameworks, RESTful APIs, database design, authentication systems, and responsive UI development. The course emphasizes industry best practices, clean code principles, and agile collaboration methods through real-world company projects.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Full-Stack Technologies</h3>
                    <p className="text-sm text-gray-600">
                      MERN/PERN stack with TypeScript, Next.js, Express, PostgreSQL/MongoDB, and modern DevOps tools.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Database Design</h3>
                    <p className="text-sm text-gray-600">
                      Students design and implement scalable database schemas with proper normalization and optimization.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Rapid iteration cycles with regular deliverables and continuous integration practices.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Weekly Demos</h3>
                    <p className="text-sm text-gray-600">
                      Teams present working features every week to maintain accountability and momentum.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                ...
                <ul className="space-y-3 ml-8">
                  <li className="text-gray-700 text-sm">
                    <strong>Sign Tampere NDA (if applicable):</strong> Required for projects involving sensitive business data.
                  </li>
                  <li className="text-gray-700 text-sm">
                    <strong>Provide full-stack mentorship:</strong> A senior full-stack developer for technical guidance on both frontend and backend.
                  </li>
                  <li className="text-gray-700 text-sm">
                    <strong>API access or specifications:</strong> Either provide sandbox API access or detailed API specifications for integration.
                  </li>
                  <li className="text-gray-700 text-sm">
                    <strong>Weekly feedback sessions:</strong> Attend weekly demo sessions to provide feedback and validate feature implementations.
                  </li>
                </ul>
              </div>
            </section>
